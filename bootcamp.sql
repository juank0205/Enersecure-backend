-- Assuming `provinces` and `cities` already exist
-- If not, uncomment and adjust accordingly
...
CREATE TABLE provinces (
  province_id int(2) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO cities (city_id, name, state, province_id)
VALUES
	(1,'Abriaquí',1,5),
	(2,'Acacías',1,50),
	(3,'Acandí',1,27),
...
CREATE TABLE solar_pannels (
    pannel_id INT AUTO_INCREMENT PRIMARY KEY,
    model VARCHAR(100),
    max_capacity INT,
    maintainance_rate INT,
    efficiency FLOAT,
    rent_price FLOAT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE turbines (
    turbine_id INT AUTO_INCREMENT PRIMARY KEY,
    model VARCHAR(100),
    height FLOAT,
    maintainance_rate INT,
    efficiency FLOAT,
...
CREATE TABLE client_solar_pannel_rent (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (client_id) REFERENCES clients(client_id),
    FOREIGN KEY (address_id) REFERENCES client_addresses(client_address_id),
    FOREIGN KEY (solar_pannel_id) REFERENCES solar_pannels(pannel_id)
);

CREATE TABLE client_turbine_rent (
    rent_id INT AUTO_INCREMENT PRIMARY KEY,
    client_id INT,
    address_id INT,
    turbine_id INT,
